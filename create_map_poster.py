...
def create_poster(city, country, point, dist, output_file, aspect='portrait', output_format='png', country_label=None, city_text=None):
    ...
    country_text = country_label if country_label is not None else country.upper()
